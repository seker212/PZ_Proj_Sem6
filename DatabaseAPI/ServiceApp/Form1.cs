...
namespace ServiceApp
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            var request = new RestRequest("api/Orders/service", DataFormat.Json);
            ...
            try
            {
                ...
                listBox1.Invoke(new Action(() =>
                {
                    try
                    {
                        ...
                        orderBox1_Id = orders.ElementAt(0).id;
                        button1.Invoke(new Action(() => button1.Text = "Wydano"));
                    }
            ...
            try
            {
                ...
                listBox2.Invoke(new Action(() => {
                    try {
                        ...
                        orderBox2_Id = orders.ElementAt(1).id;
                        button2.Invoke(new Action(() => button2.Text = "Wydano"));
                    }
                    catch (ArgumentOutOfRangeException f)
                    {
                        listBox2.Items.Add("Brak zamówień");
            ...
            try
            {
                ...
                listBox3.Invoke(new Action(() => {
                    try
                    {
                        ...
                        orderBox3_Id = orders.ElementAt(2).id;
                        button3.Invoke(new Action(() => button3.Text = "Wydano"));
                    }
                    catch (ArgumentOutOfRangeException f)
                    {
                        listBox3.Items.Add("Brak zamówień");
        ...
        {
            listBox1.Items.Clear();
            listBox1.Items.Add("Wydano zamówienie, wczytuję nowe");
            var client = new RestClient("https://localhost:44328/");
            var request_done = new RestRequest("api/Orders/service/" + orderBox1_Id, DataFormat.Json);
            ...
            //put api/Orders/service/{orderId}
        }

        private void button2_Click(object sender, EventArgs e)
        {
            listBox2.Items.Clear();
            listBox2.Items.Add("Wydano zamówienie, wczytuję nowe");
            var client = new RestClient("https://localhost:44328/");
            var request_done = new RestRequest("api/Orders/service/" + orderBox2_Id, DataFormat.Json);
            var response_done = client.Put(request_done);
        ...
        {
            listBox3.Items.Clear();
            listBox3.Items.Add("Wydano zamówienie, wczytuję nowe");
            var client = new RestClient("https://localhost:44328/");
            var request_done = new RestRequest("api/Orders/service/" + orderBox3_Id, DataFormat.Json);
            var response_done = client.Put(request_done);
